// Team NAME_SPACE (Orion Roven, Paul Serbanescu, Max Schneider)
// APCS pd7
 ...
 *
 * ALGO:
 1) Find greatest element in the list and put switch it with whatever was at the rightmost postition
 2) Ignoring the last position, repeat the same process but switch it with whatver was at position (length - 1)
 3) Continue until the list is sorted (position = 0)
 *
 * DISCO
 *
 * QCC
