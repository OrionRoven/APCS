...
public class YoRPG {
     ...
     * to begin a new game pre: post: according to user input, modifies instance var
     * for difficulty and instantiates a Protagonist
     * =============================================
     */
    public void newGame() {
        String s;
     ...
     * round of combat pre: Protagonist pat has been initialized post: Returns true
     * if player wins (monster dies). Returns false if monster wins (player dies).
     * =============================================
     */
